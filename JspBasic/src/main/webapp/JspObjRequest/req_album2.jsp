		...
		<%-- <form action="req_album_result.jsp"> --%>
			<table border = "1" width="700">
				...
				<%-- 	<td><input type="radio" name="title" value="izone"></td> --%>
					<td align="center">
						<a href="req_album_result.jsp?title=izone">
						<img src="izone.jpg" width="100" height="100">
						</a>
					</td>
					
					<td>아이즈원</td>
					<td><a href="req_album_result.jsp?title=izone">비올레타</a></td>
					<td>2019-04-01</td>
				</tr>
				...
				<%--	<td><input type="radio" name="title" value="twice"></td> --%>
					...
					<td>트와이스</td>
					<td><a href="req_album_result.jsp?title=twice">what is love</a></td>
					<td>2018-04-09</td>
				</tr>
			<%--
				<tr>
