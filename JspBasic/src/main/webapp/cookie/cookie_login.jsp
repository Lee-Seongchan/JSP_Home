...
<%
	/*
		- 생성된 id_cookie 쿠키를 검색하여 쿠키가 이미 존재한다면 로그인 창 대신에 브라우저에 
		"이미 로그인한 사용자입니다."를 출력 후 welcome페이지로 이동할 수 있는 링크를 제공하세요.
...
<body>
	<%if(!flag){ %> <!-- flag가 false(쿠키가 없으면)이면 true가 되어 로그인 페이자가 뜬다. -->
	...
	<%}else {%>
		...
		<a href="cookie_login_welcome.jsp"></a>
	<%} %>
